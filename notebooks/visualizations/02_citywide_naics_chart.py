...
naics_gdf = gpd.read_parquet(os.path.join(root, 'data/processed/ALL_openings_closings_by_naics_neighs_year.parquet'))
...
fig.write_html(os.path.join(root, 'outputs/citywide_naics_chart.html'))
fig.show()
